...
build() {
    ...
    mkdir -p $DESTDIR/lib/sparcv9
    cp files/lib-libmtsk.so.1 $DESTDIR/lib/libmtsk.so.1
    cp files/lib-libmtsk_db.so.1 $DESTDIR/lib/libmtsk_db.so.1
    cp files/lib-sparcv9-libmtsk.so.1 $DESTDIR/lib/sparcv9/libmtsk.so.1
    cp files/lib-sparcv9-libmtsk_db.so.1 $DESTDIR/lib/sparcv9/libmtsk_db.so.1
}
