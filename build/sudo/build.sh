...
CONFIGURE_OPTS_64="$CONFIGURE_OPTS_64 --libexecdir=/usr/lib/sudo/sparcv9"
...
make_install64() {
    ...
    make_install
    # Now cleanup the bits we didn't want (sparcv9 bins/includes)
    logcmd rm -rf $DESTDIR/usr/bin/sparcv9
    logcmd rm -rf $DESTDIR/usr/sbin/sparcv9
    logcmd rm -rf $DESTDIR/usr/include/sparcv9
}
